...
class UpdateViajeroRequest extends FormRequest
{
    /**
    ...
    {
        //'cedula' => ['required', 'cedula', 'unique:viajeros,cedula,$id']
        //dd($this->route('viajero'));
        return [
            'nombre'            => 'required|min:1|max:50',
            'cedula' => 'required|unique:viajeros,cedula,'.$this->route('viajero')->id,
